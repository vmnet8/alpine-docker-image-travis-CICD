...
# get_my_manifest_sha is going to get vmnet8/alpine docker image's sha, three archectures: amd64 and arm arm64
get_vmnet8_manifest_sha (){
    local repo=$1  # my repo name vmnet8/alpine:latest
    local arch=$2
